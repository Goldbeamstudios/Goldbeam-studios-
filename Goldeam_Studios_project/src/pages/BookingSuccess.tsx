...
export default function BookingSuccess() {
    return (
        <div className="min-h-screen bg-black text-white flex items-center justify-center pt-24 pb-20 px-4">
            <div className="max-w-2xl w-full text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                    <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl flex items-center gap-4 text-left">
                        <div className="bg-amber-500/10 p-3 rounded-xl">
                            <Calendar className="h-6 w-6 text-amber-500" />
                        </div>
                        <div>
                            <p className="text-xs font-bold text-gray-500 uppercase">What's Next?</p>
                            <p className="text-sm text-gray-300">Prepare your script & assets</p>
                        </div>
                    </div>
                    <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl flex items-center gap-4 text-left">
                        <div className="bg-amber-500/10 p-3 rounded-xl">
                        ...
                        <div>
                            <p className="text-xs font-bold text-gray-500 uppercase">Check Inbox</p>
                            <p className="text-sm text-gray-300">View confirmation details</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                        to="/"
                        className="bg-white text-black px-10 py-4 rounded-xl font-black uppercase tracking-widest hover:bg-gray-200 transition-all flex items-center justify-center gap-2"
                    >
                        Return Home
                    </Link>
                    <Link
