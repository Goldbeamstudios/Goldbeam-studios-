        ...
        <div className="bg-white dark:bg-black text-zinc-900 dark:text-white min-h-screen transition-colors duration-300">
            ...
            <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0 bg-zinc-50 dark:bg-black">
                    ...
                    <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[70%] bg-amber-600/5 dark:bg-amber-600/10 blur-[120px] rounded-full animate-pulse-slow"></div>
                    <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[70%] bg-amber-500/5 dark:bg-amber-500/10 blur-[120px] rounded-full animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
                </div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
                    ...
                    <h1 className="text-6xl md:text-8xl font-black text-zinc-900 dark:text-white uppercase tracking-tight mb-8 leading-[0.9] animate-slide-up">
                        Location & <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-amber-400 to-amber-600 animate-gradient">
                            Parking
                        </span>
                    </h1>
                    <p className="text-xl text-zinc-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed animate-fade-in-delay">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-10 animate-on-scroll opacity-0">
                            <div className="space-y-2">
                                ...
                                <h3 className="text-5xl font-black uppercase text-zinc-900 dark:text-white leading-[1.1]">Goldbeam <br /> Headquarters</h3>
                            </div>

                            <div className="space-y-6">
                                <div className="flex items-start gap-6 group">
                                    <div className="mt-1 p-3 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 rounded-2xl group-hover:border-amber-500/30 transition-colors">
                                        <MapPin className="h-6 w-6 text-amber-500" />
                                    </div>
                                    <div>
                                        <p className="text-2xl font-bold text-zinc-900 dark:text-white mb-2">Danforth Ave</p>
                        ...
                        >
                            ...
                            <div className="relative p-2 bg-zinc-100 dark:bg-zinc-900 border border-amber-500/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
                                <div className="relative h-[600px] rounded-[2rem] overflow-hidden">
                                    <iframe
                                        ...
                                        loading="lazy"
                                        className="relative z-0 grayscale-[0.2] dark:grayscale-[1] dark:invert-[0.9]"
                                    ></iframe>
                                </div>
                                {/* Decorative UI elements */}
                                <div className="absolute top-8 left-8 p-4 bg-white/80 dark:bg-black/80 backdrop-blur-xl border border-zinc-200 dark:border-white/10 rounded-2xl z-20">
                                    <div className="flex items-center gap-3">
                                        <div className="w-3 h-3 bg-amber-500 rounded-full animate-ping"></div>
                                        <span className="text-[10px] font-black uppercase tracking-widest text-zinc-900 dark:text-white">Live Studio Location</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-32 bg-zinc-50 dark:bg-zinc-950/50 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-24 animate-on-scroll opacity-0">
                        ...
                        <h3 className="text-5xl md:text-6xl font-black uppercase text-zinc-900 dark:text-white">Parking Options</h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        {[
                            ...
                            <div
                                key={i}
                                className="animate-on-scroll opacity-0 group relative p-10 bg-white dark:bg-zinc-900/50 backdrop-blur-xl border border-zinc-200 dark:border-white/5 rounded-[2.5rem] hover:border-amber-500/50 transition-all duration-500 shadow-xl shadow-zinc-200/50 dark:shadow-none"
                            ...
                            >
                                ...
                                <div className="relative z-10 space-y-6">
                                    ...
                                    <h4 className="text-3xl font-black uppercase text-zinc-900 dark:text-white group-hover:text-amber-500 transition-colors">{item.title}</h4>
                                    <p className="text-zinc-600 dark:text-gray-400 text-lg leading-relaxed">{item.desc}</p>
            ...
            <section className="py-32">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="animate-on-scroll opacity-0 relative group p-1 bg-gradient-to-br from-amber-500/40 via-transparent to-amber-600/40 rounded-[3.5rem]">
                        <div className="relative bg-zinc-50 dark:bg-zinc-900 rounded-[3.4rem] overflow-hidden p-12 md:p-24">
                            {/* Dynamic Background */}
                            ...
                            <div className="absolute inset-0 bg-gradient-to-r from-zinc-50 dark:from-black via-zinc-50/80 dark:via-black/80 to-transparent"></div>
                            ...
                            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                <div className="space-y-8 text-center lg:text-left">
                                    ...
                                    <h2 className="text-5xl md:text-7xl font-black uppercase leading-[0.9] text-zinc-900 dark:text-white transition-colors">
                                    ...
                                    <div className="flex flex-col md:flex-row items-center gap-8 justify-center lg:justify-start">
                                        ...
                                        <p className="text-xl text-zinc-600 dark:text-gray-400 max-w-sm leading-relaxed transition-colors">
                                ...
                                <div className="hidden lg:flex items-center justify-center">
                                    <div className="relative w-80 h-80">
                                        ...
                                        <div className="relative w-full h-full bg-white dark:bg-zinc-900 backdrop-blur-3xl border border-zinc-200 dark:border-amber-500/10 rounded-full flex items-center justify-center p-12 transition-all">
            ...
            <section className="py-32 relative overflow-hidden bg-white dark:bg-black">
                <div className="max-w-4xl mx-auto px-4 text-center space-y-20 relative z-10">
                    <div className="animate-on-scroll opacity-0 space-y-16">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
                            ...
                            <div className="group space-y-4 p-8 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-amber-500/10 rounded-3xl hover:border-amber-500/30 transition-all">
                                ...
                                <h4 className="text-2xl font-black uppercase text-zinc-900 dark:text-white">Need Guidance?</h4>
                                <p className="text-zinc-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <div className="animate-on-scroll opacity-0 pt-20 border-t border-white/5">
                        ...
                        <Link
                            to="/contact"
                            className="group text-4xl md:text-6xl font-black uppercase text-zinc-900 dark:text-white hover:text-amber-500 transition-all inline-flex flex-col items-center gap-6"
                        >
                            Contact Us for Help
